...
def setup_product():
    ...
    import iscorpio.plonerm
    zcml.load_config('configure.zcml', iscorpio.plonerm)
    ...
    ztc.installPackage('iscorpio.plonerm')
...
setup_product()
ptc.setupPloneSite(products=['iscorpio.plonerm'])

class PlonermTestCase(ptc.PloneTestCase):
    """We use this base class for all the tests in this package. If necessary,
    we can put common utility or setup code in here. This applies to unit 
    test cases.
    """

class PlonermFunctionalTestCase(ptc.FunctionalTestCase):
