...
# Currently, we only add one permission for each new type in this
# product. For this shell console product, we expect different
# permission type, such as view, execute, etc.
# Should we set up those permission here or some where else?
