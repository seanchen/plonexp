...
def setup_product():
    ...
    zcml.load_config('configure.zcml', leocornus.ygedf)
    ...
    # 
    ztc.installPackage('leocornus.ygedf')
...
setup_product()
ptc.setupPloneSite(products=['leocornus.ygedf'])

class YgedfTestCase(ptc.PloneTestCase):
    """
...
class YgedfPortletTestCase(YgedfTestCase):
    """
