...
XPointContactSchema = ATCTContent.schema.copy() + Schema((
        ...
        DataGridField(
            ...
            searchable = True,
            required = False,
            columns = ('phone_type', 'phone_number', 'memo'),
            allow_empty_rows = False,
            widget = DataGridWidget(
        ...
        DataGridField(
            ...
            searchable = True,
            required = False,
            columns = ('address_type', 'address', 'city', 'province', 'postcode', 'country', 'memo'),
            allow_empty_rows = False,
            widget = DataGridWidget(
                label = u'Addresses',
                auto_insert = False,
...
# the class.
class XPointContact(XPCMBase, ATCTContent):
